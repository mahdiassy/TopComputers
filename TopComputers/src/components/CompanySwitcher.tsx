...
const CompanySwitcher = () => {
  const { companies, currentCompany, switchCompany, loading } = useCompanies();
  ...
  return (
    <div className="relative">
      ...
      >
        <FiHome className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600 dark:text-blue-400" />
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-64 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-lg z-20 mx-4 sm:mx-0">
            <div className="py-1">
              ...
              {companies
                .sort((a, b) => {
                  // Sort by creation date - oldest first (Default Company should be first)
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {company.description && (
                      <div className="text-xs text-secondary truncate">{company.description}</div>
                    )}
                  </div>
                  {company.id === currentCompany.id && (
